...
sp_beaches <- read_excel("vscode-workspace/Estudos/study/Projeto_Estatistica/sp_beaches.xlsx", sheet = 1, col_names = TRUE)
...
ggplot(dados_estatisticos, aes(x = reorder(Beach, -amostras), y = amostras, fill = Beach)) +
...
ggplot(dados_estatisticos, aes(x = "", y = amostras, fill = Beach)) +
